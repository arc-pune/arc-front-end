            ...
            <div className="container px-5 pb-2 mx-auto justify-center flex flex-wrap">
                ...
                <div className="flex w-full mb-10 justify-center flex-wrap">
                    <p className="lg:pl-6 lg:w-2/3 md:font-sans font-medium leading-relaxed text-dark-grey">
                        Feeding, Rescue and Adoptions are our main domain of
                        work. Our volunteers daily feed 500+ dogs and cats in
                        their respective areas. Adoption is our prominent
                        feature.
                    </p>
                </div>
