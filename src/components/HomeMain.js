      ...
      <div className="justify-center align-center py-20">
        <div className="home-main lg:flex items-center sm:justify-center">
          <div className="left lg:w-1/2 p-5 max-w-lg">
            ...
            <p>
              <strong>Animal Rescue Community (ARC), Pune</strong> is a group of college students
              ...
              passive volunteers all over Pune. <br /><br/>Feeding, Rescue and
              Adoptions are our main domains of work. Our volunteers daily feed
              500+ dogs and cats in their respective areas. Adoption is our
              prominent feature. We have been a part of 225+ successful
              adoptions till date. We also take rescue cases enthusiastically.
              We believe in coexistence and work for reducing human-animal
              conflicts. <br /><br/>
              <strong>ARC</strong> has recently started working in Nanded, being the first ever
