    ...
    <div className="text-gray-600 body-font md:min-w-screen md:h-screen left-0 top-0 inset-0 z-50 fixed">
      ...
      <div className="relative m-6 my-10 lg:px-20 lg:py-10 " style={{marginTop:"1vh"}} >
        <div style={{maxWidth:"1100px"}} className="container md:min-w-5xl md:h-full  mx-auto justify-center flex flex-wrap sm:flex-nowrap ">
          <div
            className="lg:max-w-lg lg:w-1/3 lg:p-auto sm:w-1/2 md:py-1 px-1 md:w-1/2 w-full "
...
"
          ...
          <div className="lg:flex-grow w-full lg:font-semibold md:w-3/4 px-5 flex flex-col items-center text-center text-black  bg-white dark:text-white dark:bg-black">
            <div className="relative flex w-full md:justify-center m-auto justify-center">
              <div className="mx-5 md:w-full md:pt-25 lg:px-20 lg:py-10 py-5 lg:pb-16 lg:w-full xl:w-full w-full items-center">
               { ishead ?  <p className="font-bold text-3xl md:pb-10 opacity-0 md:opacity-100"> Hello! Please tell us a little about yourself </p> : ""}
                <div className="md:grid md:grid-cols-2 md:gap-6 mt-0" >
                  <div>
                    <p for="hero-field" className="leading-7 text-left text-sm md:text-base">
                      First Name
                    </p>
                    <input
                      type="text"
                      ...
                      className="w-full bg-gray-100  lg:my-5 rounded border mb-2  bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-sm md:text-base md:py-1 outline-none text-black dark:text-white px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                  </div>
                  <div>
                    <p for="hero-field" className="leading-7 text-left text-sm -mt-1 md:text-base">
                      Last Name
                    </p>
                    <input
                      type="text"
                      ...
                      className="w-full bg-gray-100 rounded-md  lg:my-5 border mb-5  bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-sm md:text-base md:py-1 outline-none text-black dark:text-white px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                  </div>
                  <div>
                    <p for="hero-field" className="leading-7 text-left text-sm -mt-3 md:text-base">
                      Phone Number
                    </p>
                    <input
                      type="tel"
                  ...
                  <div>
                    <p for="hero-field" className="leading-7 text-left -mt-3 text-sm md:text-base">
                     Alt-Phone Number
                    </p>
                    <input
                      type="tel"
                      ...
                      name="phone"
                      placeholder="+91"
                      className="w-full bg-gray-100 rounded-md  lg:my-5 border mb-5  bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-sm md:text-base outline-none text-black dark:text-white md:py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                  </div>
                </div>
                <p for="hero-field" className="leading-7 text-left -mt-3 text-sm md:text-base">
